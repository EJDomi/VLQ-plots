...
///////////////////
makeStack("ht","ht>1100&&isRegionA","Tprime1200_LH","H_{T} [GeV]", "Events/80 GeV","htRegionA_HTWt-Fig28",1,1,19,1100,2600,"EvtWeight*EvtWtHT*EvtWtPV");
makeStack("ht","ht>1100&&isRegionB","Tprime1200_LH","H_{T} [GeV]", "Events/80 GeV","htRegionB_HTWt-Fig28",1,1,19,1100,2600,"EvtWeight*EvtWtHT*EvtWtPV*topSF(ptTopTagged)");
makeStack("ht","ht>1100&&isRegionC","Tprime1200_LH","H_{T} [GeV]", "Events/80 GeV","htRegionC_HTWt-Fig28",1,1,19,1100,2600,"EvtWeight*EvtWtHT*EvtWtPV*btagsf");

makeStack("npv","ht>1100","Tprime1200_LH","nPV","Events","npv_HTWt-Fig10",1000,1,35,0,35,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("tau3AK8/tau2AK8","ht>1100","Tprime1200_LH","#tau_{32}","Jets","tau32_HTWt-Fig8",1000,1,50,0,1,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("SoftDropMassAK8","ht>1100","Tprime1200_LH","SoftDropMass [Gev]","Jets","softDropMass_HTWt-Fig7",1,1,40,0,800,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("min(sj0CSVAK8,sj1CSVAK8)","ht>1100&&(sj0CSVAK8>0.605||sj1CSVAK8>0.605)","Tprime1200_LH","subjet CSV","Jets","sjCSV2ndh_HTWt-Fig6",1000,1,50,0,1,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("sj0CSVAK8","ht>1100","Tprime1200_LH","subjet CSV","Jets","sj0CSV_HTWt-Fig9",1000,1,50,0,1,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("sj1CSVAK8","ht>1100","Tprime1200_LH","subjet CSV","Jets","sj1CSV_HTWt-Fig9",1000,1,50,0,1,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("tau2AK8/tau1AK8","ht>1100","Tprime1200_LH","#tau_{21}","Jets","tau21_HTWt-Fig5",1000,1,50,0,1,"EvtWeight*EvtWtHT*EvtWtPV");

makeStack("PrunedMassAK8","ht>1100","Tprime1200_LH","Pruned Mass [GeV]","Jets","PrunedMass_HTWt-Fig4",1,1,40,0,800,"EvtWeight*EvtWtHT*EvtWtPV");
...
makeStack("ht","ht>1100","Tprime1200_LH","H_{T} [GeV]","Events/80GeV","ht_HTWt-Fig16",1000,1,19,1100,2600,"EvtWeight*EvtWtPV*EvtWtHT");

makeStack("nAK4","ht>1100","Tprime1200_LH","# AK4 Jets","Events","nAK4_HTWt-Fig17",1,1,10,0,10,"EvtWeight*EvtWtPV*EvtWtHT");
makeStack("nAK8","ht>1100","Tprime1200_LH","# AK4 Jets","Events","nAK8_HTWt-Fig17",1,1,10,0,10,"EvtWeight*EvtWtPV*EvtWtHT");


makeStack("ptAK4","ht>1100","Tprime1200_LH","p_{T} AK4 Jets [GeV]","Jets/20 GeV","ptAK4_HTWt-Fig18",1000,1,35,0,700,"EvtWeight*EvtWtPV*EvtWtHT");
makeStack("ptAK8[idxAK8[0]]","ht>1100&&","Tprime1200_LH","p_{T} Leading AK8 Jets [GeV]","Jets/20 GeV","ptAK8_Leading_HTWt-Fig18",1000,1,35,0,700,"EvtWeight*EvtWtPV*EvtWtHT");

makeStack("etaAK4","ht>1100","Tprime1200_LH","#eta AK4 Jets","Jets","etaAK4_HTWt-Fig19",1000,1,50,-5,5,"EvtWeight*EvtWtPV*EvtWtHT");
makeStack("etaAK8[idxAK8[0]]","ht>1100&&","Tprime1200_LH","#eta Leading AK8 Jets","Jets","etaAK8_Leading_HTWt-Fig19",1000,1,50,-5,5,"EvtWeight*EvtWtPV*EvtWtHT");
...
hBack = (TH1D*) gROOT->FindObject("hBack");
...
makeStack("mtprime","isRegionD","Tprime1200_LH;Tprime1000_LH;Tprime1500_LH;Tprime1800_LH", "M_{T} GeV", "Events/50 GeV", "" , 1,1, 36, 600,2400,"WtTrig(ht)*EvtWeight*EvtWtHT*EvtWtPV*btagsf*topSF(ptTopTagged)");
2hSig1 = (TH1D*) gROOT->FindObject("Tprime1000_LH");
2hSig2 = (TH1D*) gROOT->FindObject("Tprime1200_LH");
2hSig3 = (TH1D*) gROOT->FindObject("Tprime1500_LH");
2hSig4 = (TH1D*) gROOT->FindObject("Tprime1800_LH");
2hBack = (TH1D*) gROOT->FindObject("hBack");

map<TString,TH1D*> signals2;

signals2.insert(make_pair(TString("Tprime1000_LH"),2hSig1));
signals2.insert(make_pair(TString("Tprime1200_LH"),2hSig2));
signals2.insert(make_pair(TString("Tprime1500_LH"),2hSig3));
signals2.insert(make_pair(TString("Tprime1800_LH"),2hSig4));
c1 = (TCanvas * ) gROOT->FindObject("c1");
c1->Clear();

DrawPlot(c1,2hBack,0,signals2,0,0,0,0,1);
